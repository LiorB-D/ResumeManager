...
function App() {
  ...
  const [resume, setResume] = useState<Resume>({
    name: "Lior Ben-David",
    email: "liorbd@outlook.com",
    phone: "(914)-602-1767",
    linkedin: "https://www.linkedin.com/in/lior-ben-david-8772471b6/",
    sections: [
      {
        title: "EDUCATION",
        items: [
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            location: "Charlottesville, Virginia",
            roles: [{
              title: "Undergraduate Teaching Fellow (Introductory Economics Courses)",
    ...
    footer: {
      title: "Honors & Skills",
      items: [
        ["Honors", "University of Virginia Echols Scholar, Nita Lowey Certificate of Special Congressional Recognition, Commended Scholar National Merit Scholarship Program"],
        ["Software", "Python, SQL, Typescript, Excel, R, Matlab, Julia, Google Big Query, Java, Swift, C#, NodeJS"],
